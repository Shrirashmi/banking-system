...
@WebServlet(value = "/validateaccholder")
public class ValidateAccountHolder extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		AccountHolder accountHolder = accountHolderService.validateAccountHolder(email, password);
...
//	else {
//			resp.sendRedirect("wrongcredentials.jsp");
//		}
